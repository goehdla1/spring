	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				[2020 롯데백화점 대구점] 아기돼지삼형제
					<아동>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.08.29 ~ 2020.08.30 | 롯데백화점 대구점 7층 문화홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c8-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전 좌석 : 9900</p>
					<br>
					<p style="color: red; font-size: 18px;">적용 가능한 할인쿠폰,이벤트를
						선택해주세요.</p>
					<br>
					
					<br> <select style="width: 300px; height: 40px;" autofocus hidden="m_sale">
