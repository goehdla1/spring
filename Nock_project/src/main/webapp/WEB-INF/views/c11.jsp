...
<body>
	...
	<table
		...
		<tr>
			...
			연극 시간을 파는 상점
				...
				<p style="text-align: left; padding-bottom: 50px;">2017.10.01 ~ 2020.11.30 | 파랑씨어터</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c11-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전석:35,000원</p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="5000원 할인권" ><a href="#">청소년 15000원(주말)</a></option>
						<option value="3000원 할인권" ><a href="#">성인 18000원(주말)</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>정해빈, 신서진, 김보람, 신희진, 이세형, 이시운, 류권하, 김범수, 소유경, 김소민, 백지연, 윤호상, 강지훈, 유인상</td>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c11-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c11-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c11-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c11-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c11-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c11-7.jpg"
