	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.08.01 ~ 2020.09.27 | 명작극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c7-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전 좌석 : 9900원</p>
					<br>
					<p style="color: red; font-size: 18px;">적용 가능한 할인쿠폰,이벤트를
						선택해주세요.</p>
					<br>
					
					<br> <select style="width: 300px; height: 40px;" autofocus hidden="">
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c7-2.jpg"
				...
				src="/resources/images/c7-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c7-4.jpg"
