...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">OPEN RUN | 대학로 극장가게</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c6-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">목, 금요일 오후 7시30분</a></option>
						<option value="시간"><a href="#"> 토,일요일 오후 4시</a></option>
				...
				<div align="center">
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="※ 예술인패스카드 할인 80% 10,000원"><a href="#">※ 예술인패스카드 할인 80% 10,000원</a></option>
						<option value=" ※ 평일할인 68% 16,000원 "><a href="#"> ※ 평일할인 68% 16,000원 </a></option>
						<option value="※ 주말할인 60% 20,000원"><a href="#">※ 주말할인 60% 20,000원</a></option>
						<option value="※ 재관람 할인 80% 10,000원"><a href="#">※ 재관람 할인 80% 10,000원</a></option>
						<option value=" 국가유공자 50% " disabled="disabled"><a
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c6-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c6-4.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c6-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c6-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c6-7.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c6-8.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<img alt=""
				src="/resources/images/m_c6-2.jpg"
				...
				<h1>할인정보</h1>
				<p>※ 예술인패스카드 할인 80% 10,000원</p>
				<p>※ 평일할인 68% 16,000원</p>
				<p>※ 주말할인 60% 20,000원</p>
				<p>※ 재관람 할인 80% 10,000원</p>
				<p>* 공휴일 주말가격 적용</p>

				<h1>캐스팅 정보</h1> <img alt="" src="/resources/images/m_c6-9.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
