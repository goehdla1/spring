...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				2020 예술의전당 어린이 가족 페스티벌 〈에스메의 여름〉
					<아동>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.08.01 ~ 2020.08.16 | 예술의전당 자유소극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c10-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">1층:40,000 / 2층:25,000</p>
					<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c10-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c10-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c10-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<h1>할인정보</h1>
				<p>※ 개막기념할인 40% (7월 29일 9시~8월 7일까지 예매 시 / 적용 회차 : 8월 1일~8월 9일)</p>
