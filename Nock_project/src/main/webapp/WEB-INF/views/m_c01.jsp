...
<body>
	...
	<table
		...
		<tr>
			...
			뮤지컬 〈블랙메리포핀스〉
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.27 ~ 2020.12.31 | 대학로 TOM 1관</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c1-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">토 오후 3시, 7시</a></option>
						<option value="시간"><a href="#">일, 공휴일 오후 2시, 6시</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:66,000원 / S석:44,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="- 장애인(1-3급) 30%할인(동반1인 포함) " disabled="disabled"><a href="#">-
								장애인(1-3급) 30%할인(동반1인 포함) </a></option>
						<option value=" - 장애인(4-6급) 30%할인(본인에 한함) " disabled="disabled"><a href="#">
								- 장애인(4-6급) 30%할인(본인에 한함) </a></option>
						<option value="- 국가유공자 30%할인(본인에 한함)" disabled="disabled"><a href="#"> -
								국가유공자 30%할인(본인에 한함) </a></option>
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>김도빈, 박민성, 이율, 임준혁, 이해준, 노윤, 임찬민, 강혜인, 이지수, 박정원, 최석진, 오승훈, 신주협, 임강희, 홍륜희</td>
				<th scope="row">관람등급</th>
				<td>16세 이상 관람가 (2005년 포함 이전 출생자 관람 가능)</td>
			</tr>
			<tr style="border: 1px solid black;">
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c1-5.jpg"
				style="width: 1050px; height: 700px;">
				<img alt="" src="/resources/images/m_c1-6.jpg"
				style="width: 1050px; height: 700px;">
				<img alt="" src="/resources/images/m_c1-7.jpg"
				style="width: 1050px; height: 700px;"><img alt="" src="/resources/images/m_c1-8.jpg"
				style="width: 1050px; height: 700px;"><img alt="" src="/resources/images/m_c1-9.jpg"
				style="width: 1050px; height: 700px;">
				</td>
		</tr>
	</table>
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<img alt="" src="/resources/images/m_c1-2.jpg"
				style="width: 1050px; height: 700px;">	
			<img alt="" src="/resources/images/m_c1-3.jpg"
				style="width: 1050px; height: 700px;">	
				...
				<img alt="" src="/resources/images/m_c1-10.jpg"
				style="width: 1050px; height: 700px;">
