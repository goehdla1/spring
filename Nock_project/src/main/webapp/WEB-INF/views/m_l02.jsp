...
<body>
		...
		<tr>
			<td colspan="2">
				<h1 style="text-align: left; color: black; font-size: 40px;">
					2020웰컴대학로-웰컴씨어터 ‘국악쇼 〈썬앤문〉’
					<뮤지컬>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.10.29 ~ 2020.11.01 | 대학로 유니플렉스 1관</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_l2-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">토요일 오후 2시, 6시</a></option>
						<option value="시간"><a href="#">일요일 오후 2시</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">VIP석:55,000원 / R석:44,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value=" ※ 어린이 할인(미취학) 40% " ><a href="#">어린이 할인(미취학) 40%</a></option>
						<option value="※ 실버 할인 40%" ><a href="#">실버 할인 40%</a></option>
						<option value="※ 복지 할인 50%"><a href="#">복지 할인 50%</a></option>
						<option value="※ 종로구민 할인 30%" ><a
								href="#">종로구민 할인 30%</a></option>
					</select>
				</div> <br> <br>
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>박나현, 서은미, 조누리, 엄희정, 김한송이, 김하연, 윤지우, 신숙경, 이미지, 선소이, 노원혜, 강한나</td>
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<img alt=""
				...
				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_l2-8.jpg"
				style="width: 1050px; height: 700px;">
