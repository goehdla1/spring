...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.29 ~
					2020.11.01 | 대학로 유니플렉스 1관</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/images.png"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">화, 목 오후 7시</a></option>
						<option value="시간"><a href="#">수, 금 오후 3시, 오후 8시</a></option>
						<option value="시간"><a href="#">토 오후 2시, 오후 7시</a></option>
						<option value="시간"><a href="#">일 오후 3시</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">VIP석:150,000원 / R석:130,000원 /
						S석:100,000원 / A석:80,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="※ 국악인 할인 40%"><a href="#">국악인 할인 40%</a></option>
						<option value=" ※ 어린이 할인(미취학) 40% "><a href="#">어린이
								할인(미취학) 40%</a></option>
						<option value="※ 실버 할인 40%"><a href="#">실버 할인 40%</a></option>
						<option value="※ 복지 할인 50%"><a href="#">복지 할인 50%</a></option>
						<option value="※ 종로구민 할인 30%"><a href="#">종로구민 할인 30%</a></option>
					</select>
				</div> <br> <br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_l2-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_l2-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_l2-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l2-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l2-6.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1> <img alt=""
				src="/resources/images/m_l2-7.jpg"
				...
				<h1>할인정보</h1> <img alt="" src="/resources/images/m_l2-8.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
