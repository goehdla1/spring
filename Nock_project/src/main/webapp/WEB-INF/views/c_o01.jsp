...
<body>
	...
	<table
		...
		<tr>
			...
			다닐 트리포노프 피아노 리사이틀
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.06 ~ 2020.10.06 | 예술의전당 콘서트홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/co_1-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:120,000원 / S석:90,000원 / A석:60,000원 / B석:40,000원 </p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="장애등급 1-3급 : 50% 할인" ><a href="#">장애등급 1-3급 : 50% 할인</a></option>
						<option value="장애인 4급 이하: 50% 할인"><a href="#"> 장애인 4급 이하: 50% 할인</a></option>
						<option value="문 국가 유공자, 의상자 부상자 등급 1-2급: 50% 할인"><a href="#"> 국가 유공자, 의상자 부상자 등급 1-2급: 50% 할인</a></option>
						<option value="국가유공자 유족증, 의사자 유족증, 의상자 부상등급 3급 이하: 50%"><a href="#">국가유공자 유족증, 의사자 유족증, 의상자 부상등급 3급 이하: 50%</a></option>
						<option value=" 문화릴레이티켓 10%" disabled="disabled"><a href="#"> 문화릴레이티켓 10%</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/co_1-2.jpg"
				style="width: 1050px; height: 700px;"> 
				<img alt="" src="/resources/images/co_1-3.jpg"
				style="width: 1050px; height: 700px;"> 
				<img alt="" src="/resources/images/co_1-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<p>※ 본 공연은 네이버 쿠폰이 적용되지 않습니다.</p>
				...
				<h1>할인정보</h1>
				<p>※ 장애등급 1-3급 : 50% 할인 (본인 및 동반1인)</p>
				<p>※ 장애인 4급 이하: 50% 할인 (본인만)</p>
				<p>※ 국가 유공자, 의상자 부상자 등급 1-2급: 50% 할인 (본인 및 동반1인)</p>
				<p>※ 국가유공자 유족증, 의사자 유족증, 의상자 부상등급 3급 이하: 50% (본인만)</p>
				<p>* 할인에 해당하는 증빙자료(학생증, 신분증, 복지카드, 유공자증 등) 미지참시에는 현장에서 차액을 지불한 후 관람이 가능합니다. </p>
