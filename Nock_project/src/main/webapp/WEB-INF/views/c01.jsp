...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.12.24 ~
					2020.12.27 | 청주아트홀(구 청주시민회관)</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c1-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">S석 : 50,000 / R석 : 30,000</p>
					<br>
					<p style="color: red; font-size: 18px;">적용 가능한 할인쿠폰,이벤트를
						선택해주세요.</p>
					<br> <br> <select style="width: 300px; height: 40px;"
						autofocus>
						<option value="할인쿠포 이벤트" ><a
								href="#">==할인쿠폰,이벤트==</a></option>
						<option value="회원특가 50% 할인" disabled="disabled"><a
								href="#">회원특가 50% 할인</a></option>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c1-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c1-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c1-4.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c1-5.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c1-6.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<p>※ 본 공연은 만 13세 이상 관람 가능합니다.</p>
				<p style="color: red;">* 증빙자료(학생증, 건강보험증, 여권, 주민등록등본 등) 를 반드시
					지참하여 주시기 바랍니다. 증빙 미지참 시 입장이 제한되며,</p>
				<p style="color: red;">이와 관련한 공연 당일 현장 취소, 환불 및 변경은 불가합니다.</p>
				<h1>할인정보</h1>
				<p>※ 50%할인 : 국가유공자 및 장애인(동반1인), 만65세 이상 노인(본인만), 문화누리</p>
				<p>※ 30%할인 : 청년패스(만24세이하 또는 대학생 본인), 예술인패스(본인만), 병역명문가(본인만),
					다둥이카드(본인만), 임산부(본인만)</p>
				<p>※ 20%할인 : 경기도민(본인만), 경기아트센터 카카오톡 친구(본인만) * 현장에서 티켓 수령시 증빙서류
					확인(미지참시 차액지불)</p></td>
		</tr>
	</table>
