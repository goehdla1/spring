...
<body>
	...
	<table
		...
		<tr>
			...
			더 토핑
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.12.03 ~ 2020.12.06 | 세종문화회관 S씨어터</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/cm_2-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play" hidden="play">
						...
						<option value="s"><a href="#">자유석</a></option>

					</select>
				</div>
				<div align="center">
					<br>
					<p style="font-size: 16px;">자유석:30,000원</p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="장애인, 국가유공자, 경로우대 50%" ><a href="#">장애인, 국가유공자, 경로우대 50%</a></option>
						<option value="단체(20인 이상) 20%"><a href="#">단체(20인 이상) 20%</a></option>
						<option value="나눔할인 50%"><a href="#">나눔할인 50%</a></option>
						<option value="문화예술인,예술인패스 30%"><a href="#">문화예술인,예술인패스 30%</a></option>
						<option value="문화릴레이티켓 30%" ><a href="#">문화릴레이티켓 30%</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/cm_2-2.jpg"
