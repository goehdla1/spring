...
<body>
		...
		<tr>
			<td colspan="2">
				<h1 style="text-align: left; color: black; font-size: 40px;">
					[부산][판타지액션 어린이뮤지컬] 더퀸_선덕여왕의 귀환
					<아동>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.12.05 ~ 2020.12.06 | 부산 동래문화회관 대극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c4-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전좌석 : 35,000</p>
					<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c4-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c4-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c4-4.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c4-5.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<h1>할인정보</h1>
				<p>*사전예매 1인 16,000 (55%할인 / 11.22일 예매시까지)</p>
				<p>- 2인패키지 70,000 -> 44,000원 (40%할인) / 1인 22,000원</p>
				<p>- 3인패키지 105,000 -> 60,000원 (45%할인) / 1인 20,000원</p>
				<p>- 4인패키지 140,000 -> 72,000원 (50%할인) / 1인 18,000원</p></td>
		</tr>
	</table>
