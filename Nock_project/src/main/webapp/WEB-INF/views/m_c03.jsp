...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.08.11 ~ 2020.11.08 | 세종문화회관 S씨어터</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c3-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">평일 오후 8시</a></option>
						<option value="시간"><a href="#">주말 및 공휴일 오후 2시, 6시</a></option>
					</select> <select style="width: 200px; height: 40px;" autofocus>
						<option value="=== 좌석 선택 ==="><a href="#"></a>=== 좌석 선택
							===
						</option>

						<option value="s"><a href="#">스테이지석</a></option>
						<option value="s"><a href="#">R석</a></option>
						<option value="s"><a href="#">S석</a></option>
						<option value="s"><a href="#">갤러리석</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">스태이지석:80,000원 / R석:65,000원 /
						S석:50,000원 / 갤러리석:50,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="- 재관람 20% "><a href="#">- 재관람 20% </a></option>
						<option value=" 청소년 할인 30% "><a href="#"> 청소년할인 30%</a></option>
						<option value="직장인 할인 10%"><a href="#"> 직장인 할인 10%</a></option>
						<option value="국가유공자 50%"><a href="#"> 국가유공자
								50%</a></option>
						<option value=" 복지할인 50% " ><a
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>김재범, 김경수, 고은성, 김소향, 김려원, 이예은, 허혜진, 이건명, 에녹, 정상윤, 조형균, 장은아, 문진아, 소정화</td>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c3-14.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c3-15.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c3-16.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-17.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<p>※ 실제 좌석 위치는 예매처 페이지 내 좌석배치도 이미지를 참고 부탁드립니다. 감사합니다.</p>
			 <img alt=""
				src="/resources/images/m_c3-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c3-3.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-7.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-8.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-9.jpg"
				style="width: 1050px; height: 700px;">

				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_c3-10.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-11.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-12.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c3-13.jpg"
				style="width: 1050px; height: 700px;">


				<h1>캐스팅 정보</h1> <img alt="" src="/resources/images/m_c3-18.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
