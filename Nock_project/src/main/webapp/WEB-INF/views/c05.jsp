...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2018.12.15 ~ 2020.09.30 | 미리내마술극단 은하수홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c5-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus>
						...
						<option value="시간" disabled="disabled"><a href="#">14:00</a></option>
						...
						<option value="s" disabled="disabled"><a href="#">S석</a></option>
						<option value="a" disabled="disabled"><a href="#">A석</a></option>
						<option value="b" disabled="disabled"><a href="#">B석</a></option>
					</select>
				</div>
				<div align="center">
					<br>
					<p style="font-size: 16px;">전 좌석 : 35,000</p>
					<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c5-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c5-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c5-4.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c5-5.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c5-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c5-7.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<p>* 본 공연은 비지정석이며, 선착순입장입니다.</p>
				<p>* 36개월 미만은 무료 입장입니다.</p>
				
				<h1>할인정보</h1>
				<p>※ 단체 15인 이상 할인 기획사 문의 031-241-1238</p>
				</td>
		</tr>
	</table>
