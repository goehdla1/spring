...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.12.12 ~ 2020.12.12 | 대구 엑스코 5층 컨벤션홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c_k1-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">VIP석:134,000원 / R석:121,000원 /
						S석:99,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="-장애인할인(중증/동반1인) 20%"><a
								href="#">-장애인할인(중증/동반1인) 20%</a></option>
						<option value=" -장애인할인(경증/본인만) 20%"><a href="#"> -장애인할인(경증/본인만) 20%</a></option>
						<option value="[30%]- 학생할인(초,중,고,대학생,대학원생) "disabled="disabled"><a href="#">
								[30%] - 학생할인(초,중,고,대학생,대학원생) </a></option>
						<option value="국가유공자 유족증, 의사자 유족증, 의상자 부상등급 3급 이하: 50%" disabled="disabled"><a
								href="#">[30%] - 문화예술인예술인패스(본인), 문화릴레이(1인 2매) </a></option>
						<option value=" [50%]- 경로우대(만65세이상 본인) " disabled="disabled"><a href="#">
								[50%] - 경로우대(만65세이상 본인) </a></option>
					</select>
				</div> <br> <br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c_k1-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k1-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k1-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<p>※ 매수제한 : 공연별 1인 4매</p>
				<p>※ 일괄배송 : 11월 23일(월)</p>
				<p>※ 본 공연은 거리두기 좌석제로 운영되며 관람시 연석으로 관람할 수 없으며 본인의 옆자리는 비워져있습니다.</p>
				<p>※ 티켓분실 및 미지참시 재발권 및 입장은 절대불가하오니 티켓보관에 유의하시기 바랍니다.</p>
				<p>※ 1~4구역은 단차가 없는 평지에 간이의자가 설치되며, 가~차구역은 계단식 좌석입니다.</p>
				<p style="color: red; ">※ 10월 22일(목) 오후 5시까지 신용카드 결제만 가능합니다.</p>


				<h1>할인정보</h1>
				<p>-장애인할인(중증/동반1인) 20%</p>
				<p>-장애인할인(경증/본인만) 20%</p>
				<p>※ 중증 : (구) 1급~3급 / 경증 : (구) 4급~6급</p>
