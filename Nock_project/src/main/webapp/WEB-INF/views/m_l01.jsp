...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.08.28 ~ 2020.11.01 | 광림아트센터 BBCH홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_l1-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">화,목,금 8시</a></option>
						<option value="시간"><a href="#">수 3시, 8시</a></option>
						<option value="시간"><a href="#"> 주말 및 공휴일 2시, 6시30분</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">VIP석:140,000원 / R석:120,000원 / S석:80,000원 / A석:60,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="※ 청소년 할인 30%" ><a href="#">청소년 할인 30%</a></option>
						<option value=" ※ 마티네 할인 20% " ><a href="#">마티네 할인 20% </a></option>
						<option value="※ 장애인 할인 50%" ><a href="#">장애인 할인 50%</a></option>
						<option value="※ 복지 할인 50%" disabled="disabled"><a href="#">복지 할인 50%</a></option>
						<option value="※ 단체 할인 20%" disabled="disabled"><a
								href="#">단체할인 문의바람</a></option>
					</select>
				</div> <br> <br>
	...
	<table
		...
		<tbody>
			<tr style="border: 1px solid black;">
				...
				<td>오픈리뷰㈜ 1588-5212</td>
			</tr>
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>엄기준, 카이, 유연석, 규현, 나현우, 이지혜, 김예원</td>
				<th scope="row">관람등급</th>
				<td>8세 이상 관람가능(미취학 아동 관람 불가)</td>
			</tr>
			<tr style="border: 1px solid black;">
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_l1-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_l1-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_l1-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l1-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l1-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l1-7.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_l1-8.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<img alt=""
				src="/resources/images/m_l1-10.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_l1-11.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_l1-12.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_l1-13.jpg"
				style="width: 1050px; height: 700px;">
				...
				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_l1-14.jpg"
				style="width: 1050px; height: 700px;">
			

				<h1>캐스팅 정보</h1> <img alt="" src="/resources/images/m_l1-9.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
