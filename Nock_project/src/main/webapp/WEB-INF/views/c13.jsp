...
<body>
	...
	<table
		...
		<tr>
			...
			오리지널 가족뮤지컬 [넌특별하단다]
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.02.29 ~ 2020.03.01 | 제주 한라아트홀 대극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c13-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;"> R석:40,000원 / S석: 30,000</p>
					<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c13-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c13-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c13-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<h1>할인정보</h1>
				<p>※ 제주도민 이라면 누구나 20%할인</p>
				<p>※ 공연 리플렛 소지자 30%할인</p>
				<p>* 누구라도 4인 이상 40%할인</p>
