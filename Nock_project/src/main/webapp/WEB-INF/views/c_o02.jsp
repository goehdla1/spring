...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.11.11 ~
					2020.11.15 | 세종문화회관 대극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/co_2-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">15:00</a></option>
						<option value="시간"><a href="#">19:30</a></option>
					</select> <select style="width: 200px; height: 40px;" autofocus>
						<option value="=== 좌석 선택 ==="><a href="#"></a>=== 좌석 선택
							===
						</option>
						<option value="s"><a href="#">VIP석</a></option>
						<option value="s"><a href="#">R석</a></option>
						<option value="s"><a href="#">S석</a></option>
						<option value="s"><a href="#">A석</a></option>
						<option value="s"><a href="#">B석</a></option>

					</select>
				</div>
				<div align="center">
					<br>
					<p style="font-size: 16px;">VIP석:120,000원 / R석:100,000원 /
						S석:80,000원 / A석:50,000원 / B석:30,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="[20%] -
								서울시정책할인(다둥이,에코마일,그린,서울시민카드)"><a
								href="#">[20%] - 서울시정책할인(다둥이,에코마일,그린,서울시민카드)</a></option>
						<option value=" [20%] - 단체 20인이상 "><a href="#"> [20%]
								- 단체 20인이상 </a></option>
						<option value="[30%]- 학생할인(초,중,고,대학생,대학원생) "><a href="#">
								[30%] - 학생할인(초,중,고,대학생,대학원생) </a></option>
						<option value="국가유공자 유족증, 의사자 유족증, 의상자 부상등급 3급 이하: 50%"><a
								href="#">[30%] - 문화예술인예술인패스(본인), 문화릴레이(1인 2매) </a></option>
						<option value=" [50%]- 경로우대(만65세이상 본인) " ><a
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/co_2-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/co_2-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/co_2-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/co_2-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/co_2-6.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/co_2-7.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<p>서울시오페라단 오페라 「토스카」 '좌석간 거리두기’ 운영으로 인한 기존 예매티켓 취소 및 재오픈 안내



					안녕하세요, 서울시오페라단입니다. 기존 전좌석 판매로 진행되었던 오페라 「토스카」의 공연이 코로나 19 방역 지침에 따라
					‘객석 한칸 띄어 앉기’로 변경 되었습니다. 코로나 19 감염 확산 방지와 관객, 제작출연진 및 스태프들의 안전을 위해
					결정된 조치이므로 관객 여러분의 너그러운 이해와 협조 부탁드립니다. 이에 따라 기존 구매자 분들의 예매티켓은 수수료 없이
					일괄 취소 및 환불 될 예정입니다. 이후 ‘객석 한칸 띄어 앉기’로 변경하여 2020년 10월 12일(월) 2시 부터
					티켓 예매가 다시 진행 될 예정입니다.</p>


				<h1>할인정보</h1>
				<p>[20%] - 서울시정책할인(다둥이,에코마일,그린,서울시민카드)</p>
				<p>[30%] - 학생할인(초,중,고,대학생,대학원생)</p>
				<p>- 문화예술인예술인패스(본인), 문화릴레이(1인 2매)</p>
				<p>[50%] - 경로우대(만65세이상 본인)</p>
				<p>- 국가유공자(1인 2매), 장애인(1인 2매) .</p>
		</tr>
	</table>
