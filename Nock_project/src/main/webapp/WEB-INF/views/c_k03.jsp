...
<body>
		...
		<tr>
			<td colspan="2">
				<h1 style="text-align: left; color: black; font-size: 40px;">
					SURL（설）concert ‘Ah, ah, ah, ah What can I do?’
					<콘서트>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.08.15 ~
					2020.08.16 | 노들섬 라이브하우스</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c_k3-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:80,000원</p>
					<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c_k3-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k3-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k3-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c_k3-5.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<p>※ 매수제한 : 회차별 1인 1매</p>
				<p>※ 유의사항 - 본 공연은 지정좌석제 공연으로 예매 시 원하는 좌석을 선택하실 수 있습니다. - 예매 시
					현장수령만 선택 가능합니다. - 1인당 최대 1매까지 예매 가능합니다. - 본 공연은 거리두기 좌석제로 운영됩니다. -
					2층 객석은 안전상 이유로 유리 패널이 설치되어 있습니다. 시야 방해는 없습니다만, 개개인에 따라 불편함이 있을 수
					있습니다. - 티켓과 입장 손목밴드 수령 시 예매 내역과 예매자의 신분증 원본을 반드시 지참해주시기 바랍니다. 신분증과
					예매 확인증 둘 중 하나라도 없는 경우에는 티켓과 입장 손목밴드 수령 및 공연장 입장이 불가합니다. (개인사유로 인한
					예외 허용 절대 없음)</p>
