...
<body>
	...
	<br><br><br>
	<br>
		<h1 style="text-align: center; ">2020년 09월 01일 (화) 00:00 ~ 23:00<button style="margin-left: 1%;"><i class="fas fa-calendar" style="font-size: 32px;"></i></button></h1>
		
	
	<br>
	<br>
	<table style="width: 75%; text-align: center; border-collapse: collapse; margin: 0 auto;">
		<thead style="background-color: silver;">
			<tr style="font-size: 23px;">
				<td>No</td>
				<td colspan="2">공연상품</td>
				<td>기간</td>
				<td>점유율</td>
			</tr>
		</thead>
		<tbody>
				...
				<td style="width: 22%;"><img src="images/겨울왕국.jpg" alt="??" style="width: 60%; height: 30%; margin: 16px 0;"></td>
				<td style="text-align: left; width: 40%"><h1 style="display: inline-block; margin-left: 3%; font-size: 28px;"><a href="" style="text-decoration: none;">겨울왕국</a></h1>
					<p style="color: black; margin-left: 6%; font-size: 15px;">동화속 같은 아름다운 무대, 환상의 겨울왕국으로 초대합니다!</p>
				</td>
