...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.11.19 ~ 2021.02.07 | 두산아트센터 연강홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c7-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:88,000원 / S석:55,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="※ 예술인패스카드 할인 80% 10,000원" disabled="disabled"><a href="#">※ 예술인패스카드 할인 80% 10,000원</a></option>
						<option value=" ※ 평일할인 68% 16,000원 " disabled="disabled"><a href="#"> ※ 평일할인 68% 16,000원 </a></option>
						<option value="※ 주말할인 60% 20,000원" disabled="disabled"><a href="#">※ 주말할인 60% 20,000원</a></option>
						<option value="※ 재관람 할인 30%"><a href="#">※ 재관람 할인 30%</a></option>
						<option value="※ 중,고등학생 할인 30%" disabled="disabled"><a
								href="#">※ 중,고등학생 할인 30% </a></option>
					</select>
				</div> <br> <br>
	...
	<table
		...
		<tbody>
			<tr style="border: 1px solid black;">
				...
				<td>클립서비스 1577-3363</td>
			</tr>
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>김선영, 김지현, 김경수, 고훈정, 조형균, 최은실, 김려원, 최서연, 이예은, 이윤하, 지혜근, 김순택, 진태화, 이승헌 외</td>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c7-6.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c7-7.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c7-8.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c7-9.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c7-10.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<p style="color: blue;">* 중학생 이상 관람가 (2020년 공연 2007년 포함 이전 출생자 / 2021년 공연 2008년 포함 이전 출생자 관람가능)</p>
				<img alt=""
				src="/resources/images/m_c7-2.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_c7-3.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_c7-4.jpg"
				style="width: 1050px; height: 700px;">
				...
				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_c7-5.jpg"
				style="width: 1050px; height: 700px;">
