...
<body>
	...
	<table
		...
		<tr>
			...
			겨울왕국뮤지컬 [겨울이야기]
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.25 ~ 2020.10.25 | 청주 예술의전당 대공연장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c14-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="장애인및국가유공자 60% 할인"><a href="#">장애인및국가유공자 60% 할인</a></option>
						...
						<option value="5000원 할인권"  ><a href="#">15,000원</a></option>
						<option value="3000원 할인권" ><a href="#">마니아 할인 13,000원</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c14-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c14-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c14-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c14-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c14-6.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<p>※ 방명록작성</p>
				...
				<p>※ 예매시 할인 15,000원</p>
				<p>※ 장애인및국가유공자할인 60%</p>
				<p>※ YES마니아할인 14,000원</p>
				<p>: 공연당일 할인에 해당하는 증빙서류지참/미지참시차액지불</p>
