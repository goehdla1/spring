...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.12.12 ~
					2020.12.12 | 대구 엑스코 5층 컨벤션홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c_k2-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:132,000원 / S석:110,000원 /
						A석:88,000원 / B석:55,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="- 장애인(1-3급) 30%할인(동반1인 포함) "><a href="#">-
								장애인(1-3급) 30%할인(동반1인 포함) </a></option>
						<option value=" - 장애인(4-6급) 30%할인(본인에 한함) "><a href="#">
								- 장애인(4-6급) 30%할인(본인에 한함) </a></option>
						<option value="- 국가유공자 30%할인(본인에 한함)"><a
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c_k2-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k2-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c_k2-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c_k2-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c_k2-6.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<p>※ 9월 10일(목) 오픈되는 좌석은 기존 공연의 잔여석에 한해 진행되오니 참고부탁드립니다.</p>
				<p>※ 휠체어석은 기획사 전화예매만 가능합니다. (1566-5490)</p>
				<p>※ 티켓 분실, 파손 등 어떠한 경우에도 재발권 및 입장이 불가능하오니, 티켓보관에 유의해주시기 바랍니다.</p>
				<p>※ 공연장 주변으로는 교통 혼잡 지역이오니, 가급적 대중교통 이용바랍니다.</p>



				<h1>할인정보</h1>
				<p>- 장애인(1-3급) 30%할인(동반1인 포함)</p>
				<p>- 장애인(4-6급) 30%할인(본인에 한함)</p>
				<p>- 국가유공자 30%할인(본인에 한함)</p>
				<p>※ 할인은 기획사(1566-5490) 전화예매시 적용가능 합니다.</p>
				<p>※ 증빙서류 미지참 시 현장에서 차액 지불후 관람 가능합니다.</p>
		</tr>
	</table>
