...
<body>
	...
	<table
		...
		<tr>
			...
			[대구] 가족뮤지컬 [인어공주]
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.07.25 ~ 2020.08.09 | 대백프라임홀(대백프라자 10층)</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c15-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전 좌석: 30,000</p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="장애인및국가유공자 60% 할인"disabled="disabled"><a href="#">장애인및국가유공자 60% 할인</a></option>
						...
						<option value="5000원 할인권" disabled="disabled" ><a href="#">15,000원</a></option>
						<option value="3000원 할인권" ><a href="#">회원 할인 12,000원</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c15-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c15-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c15-4.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c15-5.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/c15-6.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<p>※ 공연장 입장시 / 관람시 마스크 필착용(미착용시 관람불가)</p>
			<p>※ 예매시 가족단위로 타 가족들간 좌석띄어서 예매하세요</p>
			<p>※ 공연장 입장시 체온체크(고열시 입장불가)</p>
			<p>※ 방명록작성</p>
