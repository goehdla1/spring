...
<body>
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">
					2020.08.01 ~ 2020.09.27 | 경복궁아트홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c2-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석 : 15,000 
					<br>
				...
				<br><br>
				<div align="center" style="margin-bottom: 50px;"><button style="width: 250px; color: white; background: red; padding: 10px; font-size: 20px;">예약하기</button></div>
	...
	<table
		...
		<tbody>
			<tr style="border: 1px solid black;">
				...
				<td>오렌지아트컴퍼니(오렌지연극학교)</td>
				<th scope="row">소비자상담</th>
				<td>02-735-0506</td>
			</tr>
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>서정화,정춘권,이혜경,김양훈,정영석</td>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c2-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c2-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c2-4.jpg"
