...
<body>
	...
	<table
		...
		<tr>
			...
			국립발레단〈해적〉
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.11.04 ~ 2020.11.08 | 예술의전당 오페라극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/cm_3-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play" hidden="play">
						<option value="=== 관람 시간 ==="><a href="#"></a>=== 관람 시간
							===
						</option>
						<option value="시간"><a href="#">17:00</a></option>
						<option value="시간"><a href="#">19:00</a></option>
						...
						<option value="s"><a href="#">C석</a></option>

					</select>
				</div>
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:80,000원 / S석:60,000원 / A석:40,000원 / B석:20,000원 / C석:5,000원</p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="코로나19 극복 국민문화건강 증진 할인 40%" ><a href="#">코로나19 극복 국민문화건강 증진 할인 40%</a></option>
						<option value="초등학생 본인 50%"><a href="#">초등학생 본인 50%</a></option>
						<option value="문화패스 청소년 본인 50%"><a href="#">문화패스 청소년 본인 50%</a></option>
						<option value="문화패스 대학생 본인 50%"><a href="#">문화패스 대학생 본인 50%</a></option>
						<option value=" 문화릴레이티켓 10%"><a href="#"> 문화릴레이티켓 10%</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/cm_3-2.jpg"
				style="width: 1050px; height: 700px;"> 
				<img alt="" src="/resources/images/cm_3-3.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			...
			<p>※ 본 공연은 YES24공연에서 진행하는 할인쿠폰이벤트 대상에서 제외됩니다.</p>
				...
				<h1>할인정보</h1>
				<p>※ 초등학생 본인 50% (2013년 12월 31일 이전 출생자까지 한함 / 생년월일 확인 가능한 증빙자료 미지참시 차액지불)</p>
				<p>※ 문화패스 청소년 본인 50% (만 13세~만 24세 이하 / 의료보험증, 신분증 등 증빙자료 미지참시 차액지불)</p>
				<p>※ 실버할인 본인 50% (만 65세 이상 / 신분증 미지참시 차액지불)</p>
				<p>※ 문화릴레이티켓 10% (티켓 1매당 2인 / 2019년~2020년 참여 기관 공연 유료티켓 미지참시 차액 지불)</p>
				<p>※ 코로나19 극복 국민문화건강 증진 할인 40% (모든 티켓 구매자 해당, 매수 제한 없음)</p>
