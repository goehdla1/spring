...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.27 ~
					2020.12.31 | 대학로 TOM 1관</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c2-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">화,목,금 오후 8시</a></option>
						<option value="시간"><a href="#">수 오후 4시,8시</a></option>
						<option value="시간"><a href="#">주말 및 공휴일 오후 3시,6시30분</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:66,000원 / S석:55,000원 /
						A석:44,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="- 재관람 30% "><a href="#">- 재관람 30% </a></option>
						<option value=" 청소년할인 A석 50% "><a href="#"> 청소년할인 A석
								50%</a></option>
						<option value="눈치우스할인권 40%"><a href="#"> - 눈치우스할인권
								40%</a></option>
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				<th scope="row">주연</th>
				<td>박민성, 임병근, 이창용, 정욱진, 기세중, 정휘, 임찬민, 홍지희</td>
				<th scope="row">관람등급</th>
				<td>8세 이상 관람가(2013년 포함 이전 출생자 관람 가능)</td>
			</tr>
			<tr style="border: 1px solid black;">
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c2-5.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c2-6.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c2-7.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c2-8.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c2-9.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c2-10.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1> <img alt=""
				src="/resources/images/m_c2-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c2-3.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c2-4.jpg"
				style="width: 1050px; height: 700px;">

				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_c2-5.jpg"
				style="width: 1050px; height: 700px;">


				<h1>캐스팅 정보</h1> <img alt="" src="/resources/images/m_c2-10.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
