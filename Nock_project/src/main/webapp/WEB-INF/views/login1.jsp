...
<body>
	...
	<div style="width: 40%; height: 50%; border: 1px solid black; background-color:silver; margin: 0 auto;">
		<br><br>
		<h2 style="text-align: center; font-size: 40px; text-decoration: underline;">회원 로그인 </h2>
		...
		<input id="i1" type="text" name="id" placeholder="아이디를 입력해주세요." ><br>
		<input id="i2" type="password" name="pw" placeholder="비밀번호를 입력해주세요.">
		</form>
