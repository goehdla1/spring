	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.24 ~ 2020.10.25 | 연세대학교 백주년기념관 콘서트홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c_k4-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:121,000원</p>
					<br>
