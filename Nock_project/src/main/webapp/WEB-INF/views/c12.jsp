...
<body>
	...
	<table
		...
		<tr>
			...
			2020 예술의전당 어린이 가족 페스티벌 〈네 네 네〉
					<아동>
				</h1>
				<p style="text-align: left; padding-bottom: 50px;">2020.08.19 ~ 2020.08.23 | 예술의전당 자유소극장</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c12-1.jpg"
			...
			<td style="border: 1px solid black;">
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">전석:15,000원</p>
					<br>
					...
					<br> <select style="width: 300px; height: 40px;" autofocus >
						...
						<option value="5000원 할인권" disabled="disabled" ><a href="#">5000원</a></option>
						<option value="3000원 할인권" disabled="disabled"><a href="#">3000원</a></option>
					</select>
				</div> <br>
			<br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c12-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c12-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c12-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				...
				<p>※ 환불 및 취소규정 안내</p>
				<p>예술의전당 어린이 가족 페스티벌 공연인 〈네네네〉(8.19~23)의 전 회차 공연이</p>
				<p>코로나19 감염 확산 방지지침(2020년 8월 19일 수도권 거리두기 2단계 강화)에 따라 취소되었습니다. 페스티벌 공연인 〈네네네〉(8.19~23)의 전 회차 공연이</p>
				
				<h1>할인정보</h1>
				<p>※ (주말)청소년 15,000원</p>
				<p>※ (주말)성인 18,000원</p>
				<p>* 청소년할인의 경우 학생증 or 청소년증 필수 지참, 미지참시 차액지불</p>
