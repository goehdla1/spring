...
<div align="left" style="width: 100%;">
	<div class="menubar" align="center" style="border-bottom: 1px solid black; width: 700px;">
		<ul>
			<li id="sub_m"><span style="font-size: 50px;">클래식/무용 - </span><a href="#"
				id="current" style="font-size: 35px;">발레/무용 ▼</a>
				<ul>
					<li id="sub_m"><a href="#" style="font-size: 23px; display: block;">클래식/오페라</a></li>
	...
	<div align="center" style="margin: 0 auto; border-bottom: 1px solid black; width: 650px;">
		<h2 style="text-align: center;">
			현재 구입 가능한 티켓은 총 <u><font style="color: red;">3개</font></u> 입니다.
		</h2>
	</div>
	<br>
	<br>
	...
	<table style="width: 70%; text-align: center; margin: 0 auto;">
		<tr>
			<td><img class="scale" src="/resources/images/c_act1.jpg"
				alt="??" style="width: 320px; height: 370px;"></td>
			<td><img class="scale" src="/resources/images/c_act2.jpg"
				alt="??" style="width: 320px; height: 370px;"></td>
			<td><img class="scale" src="/resources/images/c_act3.jpg"
				alt="??" style="width: 320px; height: 370px;"></td>
		</tr>
		<tr>
			<td style="width: 50%;">
				<h2 style="font-size: 25px; text-align: center;">바리어지다(무용)</h2>
				<p style="width: 80%;">버릴 때 버리더라도 아이 이름은 지어주고 버리소! 버려진 딸 바리의
					우여곡절 스토리</p>
				<button style="width: 65%; margin-top: 2%;">예매하기</button>
			</td>
			<td style="width: 50%;">
				<h2 style="font-size: 25px; text-align: center;">더 토핑(무용)</h2>
				<p style="width: 80%;">〈더 토핑〉은 공연제목에서 알 수 있듯이, 한국무용에 다양한 장르나 예술가
					또는 그 무엇이든 얹어 ‘컬래버레이션’ 한다는 의도를 담은 공연입니다.</p>
				<button style="width: 65%; margin-top: 2%;">예매하기</button>
			</td>
			<td style="width: 50%;">
				<h2 style="font-size: 25px; text-align: center;">국립발레단〈해적〉</h2>
				<p style="width: 80%;">모험을 하는 해적 발레단.</p>
				<button style="width: 65%; margin-top: 2%;">예매하기</button>
			</td>
		</tr>
	</table>
