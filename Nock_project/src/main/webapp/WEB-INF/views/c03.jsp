...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.10.17 ~
					2020.10.18 | 신세계백화점 대구점 8층 문화홀</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/c3-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus>
						...
						<option value="시간"><a href="#">11:30</a></option>
						<option value="시간"><a href="#">14:00</a></option>
						<option value="시간"><a href="#">16:00</a></option>
					</select>
					<select style="width: 200px; height: 40px;" autofocus>
						<option value="=== 좌석 선택 ==="><a href="#"></a>=== 좌석 선택
							===
						</option>
						<option value="a"><a href="#">R석</a></option>
					</select>
				</div>
				<div align="center">
					<br>
					<p style="font-size: 16px;">S석 : 9,900</p>
					<br>
					...
					<option value="조기예매할인" disabled="disabled"><a href="#">조기예매할인 8,900원</a></option>
						<option value="회원특가 50% 할인" disabled="disabled"><a href="#">회원특가 50% 할인</a></option>
						<option value="회원특가 30% 할인" disabled="disabled"><a href="#">회원특가 30% 할인</a></option>
						<option value="초대권" disabled="disabled"><a href="#">초대권</a></option>
						<option value="5000원 할인권" disabled="disabled"><a href="#">5000원 할인권</a></option>
						<option value="3000원 할인권" disabled="disabled"><a href="#">3000원 할인권</a></option>
					</select>
				</div> <br> <br>
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/c3-2.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c3-3.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/c3-4.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<p style="color: red;">※ 본 상품은 문화비 소득공제 제외 상품입니다.</p>
				<p>※ 구매 선착순 좌석 지정(무대기준 앞 → 뒤, 중앙 → 사이드)</p>
				<p>: 전 좌석 한 칸 띄우기 또는 한 가족 두 칸 띄우기로 운영되오니 예매 시, 참고 부탁드립니다.</p>
				<p>※ 본 공연은 가족 모두가 함께 관람할 수 있습니다. (24개월 미만 부모님 동반입장 가능-증빙서류지참)</p>
				<p>※ 1인 1티켓 적용 (본 공연은 부모님과 자녀 모두 소지하셔야 합니다.)</p>
				<p>※ 당일 변경 및 취소 불가 (공연당일 현장에서의 취소, 변경, 환불은 불가하며, 개인사정, 공연 중
					울고보채는 아이로 퇴장하는 경우에도 환불은 불가합니다.)</p>
				<p>※ 공연장 주변 교통이 혼잡하며, 주차공간이 부족하오니 가급적 대중교통을 이용해 주시기 바랍니다.</p>
				<h1>할인정보</h1>
				<p>※ 예매시 9,900원</p>
				<p>※ 조기예매할인 8,900원 (~9/13까지 예매시)</p></td>
		</tr>
	</table>
