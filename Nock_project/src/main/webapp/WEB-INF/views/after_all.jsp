...
<body>
	...
	<h1 style="text-align: center; text-decoration: underline;">김종욱 찾기
		후기</h1>
	...
	<table
		...
		<tbody>
			<tr>
				...
				<td>
					<p>
						<a href="#">남자배우가 너무 잘생기고 멋있어요!</a>
					</p>
				</td>
				<td>
					<p>2020. 09. 30. 14:00</p>
				</td>
				<td>7/5.0</td>
			</tr>
			<tr>
		...
		<tfoot>
			<tr>
				<td colspan="4" style="text-align: right;"><button style="width: 90px; margin-right: 50px;">작성하기</button></td>
			</tr>
		</tfoot>
	</table>
	<br>
