...
<body>
	...
	<table
		...
		<tr>
			<td colspan="2">
				...
				<p style="text-align: left; padding-bottom: 50px;">2020.11.24 ~ 2020.12.20 | 세종문화회관 M씨어터</p>
			</td>
		</tr>
		<tr>
			<td><img alt="" src="/resources/images/m_c5-1.jpg"
			...
			<td style="border: 1px solid black;">
				<div align="center">
					...
					<select style="width: 200px; height: 40px;" autofocus class="play"
						...
						<option value="시간"><a href="#">화,목,금 오후 7시 30분</a></option>
						<option value="시간"><a href="#"> 토 오후 3시, 오후 7시 30분</a></option>
						<option value="시간"><a href="#">수,일 오후 3시</a></option>
				...
				<div align="center">
					<br>
					<p style="font-size: 16px;">R석:70,000원 / S석:50,000원 / A석:30,000원</p>
					<br>
					...
					<br> <br> <select style="width: 300px; height: 40px;"
						...
						<option value="문화예술인 10% "><a href="#">문화예술인 10% </a></option>
						<option value=" 학생 할인 15% "><a href="#"> 학생 할인 15% </a></option>
						<option value="조기 예매 30%"><a href="#">조기 예매 30%</a></option>
						<option value="문화의날 할인 30%"><a href="#">문화의날 할인 30%</a></option>
						<option value=" 국가유공자 50% "  ><a
								href="#"> 국가유공자 50% </a></option>
					</select>
				</div> <br> <br>
	...
	<table
		...
		<tbody>
			...
			<tr style="border: 1px solid black;">
				...
				<td>만 7세 이상 (2013년 12월 31일 이전 출생자)</td>
			</tr>
			<tr style="border: 1px solid black;">
	...
	<table style="border: none; width: 70%; margin: 0 auto;">
		...
		<tr>
			<td colspan="2"><img alt="" src="/resources/images/m_c5-5.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c5-6.jpg"
				style="width: 1050px; height: 700px;"> <img alt=""
				src="/resources/images/m_c5-7.jpg"
				style="width: 1050px; height: 700px;"><img alt=""
				src="/resources/images/m_c5-8.jpg"
	...
	<table
		...
		<tr style="border: 1px solid black;">
			<td colspan="2"><h1>유의사항</h1>
				<img alt=""
				src="/resources/images/m_c5-2.jpg"
				style="width: 1050px; height: 700px;">
				<img alt=""
				src="/resources/images/m_c5-3.jpg"
				style="width: 1050px; height: 700px;">
				...
				<h1>할인정보</h1>
				<img alt=""
				src="/resources/images/m_c5-4.jpg"
				style="width: 1050px; height: 700px;">


				<h1>캐스팅 정보</h1> <img alt="" src="/resources/images/m_c5-9.jpg"
				style="width: 1050px; height: 700px;">
		</tr>
	</table>
