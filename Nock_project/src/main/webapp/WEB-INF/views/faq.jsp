...
<body>
	...
	<h1 style="text-align: center; color: red; font-size: 40px;">
		FAQ<select style="width: 23px; height: 20px;" autofocus>
			<option></option>
	...
	<div style="text-align: center;">
		<input type="text" placeholder=" search"
			style="width: 25%; height: 25px; font-size: 25px;">
		<button>검색</button>
	</div>
	...
	<table
		...
		<tbody>
			<tr style="font-size:15px;">
				<td>1</td>
				<td><a name="aa" href='javascript:void(0)' onclick=this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';>회원가입은 어떻게 하나요?</a><DIV style='display:none'>
*메인 화면에 보시면 회원가입란이 있습니다.<br> 그 곳을 누르고 가입하시면 됩니다.</DIV></td>
				<td>2020-03-14</td>
				<td>11</td>
			</tr>
			<tr style="font-size:15px;">
				<td>2</td>
				<td><a name="aa" href='javascript:void(0)' onclick=this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';>비밀번호 변경은 어떻게 하나요?</a><DIV style='display:none'>
*메인 화면에 보시면 마이페이지란이 있습니다.<br> 그 곳을 누르고 내 정보에서 바꾸시면 됩니다.</DIV></td>
				<td>2020-03-14</td>
				<td>11</td>
			</tr>
			<tr style="font-size:15px;">
				<td>3</td>
				<td><a name="aa" href='javascript:void(0)' onclick=this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none';>쿠폰 유효기간은 어떻게 되나요?</a><DIV style='display:none'>
*각 쿠폰마다 사용기간이 다릅니다. 쿠폰란에서 확인바랍니다.</DIV></td>
				<td>2020-03-14</td>
				<td>11</td>
			</tr>
