...
public class DAO {
	...
	public int getInsert(VO vo) {
		int result = 0;
			...
			// insert , update , delete : jdbcTemplate.update 사용! 리턴 = int! 
	...
	public int getUpdate(VO vo) {
		int result = 0;
			...
			// insert , update , delete : jdbcTemplate.update 사용! 리턴 = int! 
		result = jdbcTemplate.update(sql, vo.getName(),vo.getSubject(),vo.getContent(),vo.getEmail(),vo.getPwd(),vo.getIdx());
		return result;
	}
